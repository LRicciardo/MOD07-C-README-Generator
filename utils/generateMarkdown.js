...
function generateMarkdown(data) {
  // console.log (data);
  const { repoName, projName, projDesc, projSteps, projScreenShot, projResource, projLicense, badgeColor, projLang, projFeature, projTest, projGitHub, projEmail } = data;
  const badge = renderLicenseBadge(projLicense, badgeColor);
  // const link = renderLicenseLink(projLicense);
  // const section = renderLicenseSection(badge,link)
  return `# ${repoName}  --- ${projName}
  ...
  This application is using the ${projLicense} License. Clink on the badge  ${badge}  to follow the link to the license.
